...
#include "../Midgard/logic/emulator.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Emulator_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Emulator_t qt_meta_stringdata_Emulator = {
    {
QT_MOC_LITERAL(0, 0, 8), // "Emulator"
QT_MOC_LITERAL(1, 9, 14), // "prepareMessage"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 24), // "generatePoblationMessage"
QT_MOC_LITERAL(4, 50, 14) // "sendMapMessage"

    },
    "Emulator\0prepareMessage\0\0"
    "generatePoblationMessage\0sendMapMessage"
};
...
void Emulator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->prepareMessage(); break;
        case 1: _t->generatePoblationMessage(); break;
        case 2: _t->sendMapMessage(); break;
        default: ;
        }
        ...
        {
            typedef void (Emulator::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Emulator::prepareMessage)) {
                *result = 0;
            }
        }
    }
